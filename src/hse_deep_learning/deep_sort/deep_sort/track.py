...
class Track:
    ...
    def update(self, kf, detection_bbox: Rect, feature: np.ndarray):
        ...
        """
        xyah = np.array(
            [detection_bbox.center_x, detection_bbox.center_y, detection_bbox.aspect_ratio, detection_bbox.height]
        )

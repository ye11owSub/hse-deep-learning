...
def min_cost_matching(
    distance_metric, max_distance, tracks, detections, features, track_indices=None, detection_indices=None
):
...
def matching_cascade(
    ...
    for level in range(cascade_depth):
        ...
        matches_l, _, unmatched_detections = min_cost_matching(
            distance_metric, max_distance, tracks, detections, features, track_indices_l, unmatched_detections
        )
        matches += matches_l
